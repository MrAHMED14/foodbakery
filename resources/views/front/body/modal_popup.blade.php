                                ...
                                <form method="post" class="wp-user-form webkit" id="ControlForm_43687">
                                    <div class="cs-demo-login">
                                        ...
                                        <ul class="login-switches">
                                            <li>
                                                <a href="{{route('restaurant.dashboard')}}" class="btn-red demo-publisher-user"><i class="icon-food"></i> Restaurant</a>
                                            </li>
                                            <li>
                                                <a href="{{route('buyer.dashboard')}}" class="btn-red btn-green demo-buyer-user"><i class="icon-user4"></i> Buyer</a>
                                            </li>
                                        </ul>
                                    </div>
