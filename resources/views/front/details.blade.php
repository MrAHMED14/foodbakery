...
<div class="sub-header align-center">
    <div class="subheader-holder" style=" background:url({{asset('front/extra-images/subheader-img2-1.jpg')}})  no-repeat scroll 0 0 / cover; padding-top: 60px; padding-bottom: 30px; margin-top: 0px; margin-bottom: 0px; min-height: 186px !important;">
        <!-- Container Start -->
        <div class="container">
            <!-- Row Start -->
            <div class="row">
                    ...
                    <div class="filter-wrapper">
                        <div class="categories-menu">
                            ...
                            <ul class="menu-list">
                                ...
                                <li class=""><a href="#" class="menu-category-link"> Traditional Curries </a>
                                </li>
