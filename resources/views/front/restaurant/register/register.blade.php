                    ...
                    <div class="user-dashboard loader-holder">
                        <div class="user-holder">
                            <ul class="restaurant-settings-nav progressbar-nav">
                                <li class="active processing"><a href="{{route('front.register_restaurant')}}" class="cond-restaurant-settings1">Information</a></li>
                                <li><a href="{{route('front.register_package')}}" class="cond-restaurant-settings1">Select Package</a></li>
                            ...
                            <div id="restaurant-sets-holder">
                                <form class="form-fields-set foodbakery-dev-restaurant-form" method="post" action="register-select-package.html">
