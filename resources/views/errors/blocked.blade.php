                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="page-not-found">
                                ...
                                <div style="display: flex; flex-direction: column; align-items: center; gap: 0px;">
                                    <a href="{{ route('front.contact') }}" class="bgcolor" style="color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
                                        <i class="icon-support"></i>
                                        Contact Support
                                    </a>

                                    <a href="{{ route('front.index') }}" class="btn" style="padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
