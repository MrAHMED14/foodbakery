@section('title', 'Sign up - FoodBakery')
...
<x-guest-layout>
    ...
    <div class="w-full flex flex-col items-center justify-center" style="margin: 20px 0">
        <h3 class="text-xl font-bold" style="font-weight: 900;">Create an account</h3>
        <p class="text-muted"><small class="font-medium">Enter your credentials to create your account</small></p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="name" placeholder="John Doe" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" placeholder="example@example.com" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
